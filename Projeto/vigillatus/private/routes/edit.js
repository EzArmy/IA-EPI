    ...
    router.post('/delete', async (req, res) => {
        ...
        try {
            ...
            // Não é necessário deletar a pasta manualmente, o Sequelize cuidará disso
    
            // Redirecionar para alguma página após a exclusão
            res.redirect('/');
        } catch (error) {
            console.error('Erro ao deletar gestor:', error);
            res.redirect('/home/perfilGestor'); // Redirecionar de volta para a página de perfil do gestor em caso de erro
        }
    });
